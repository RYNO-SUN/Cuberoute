...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Dashboard</h1><i class=""></i>
            <a href="/addproduct" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                    class="fa fa-gift"></i> Add Product</a>
                    <a href="/addcategory" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                    class="fas fa-book fa-sm text-white-50"></i> Add Category</a>
                    <a href="/addvarient" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                    Different Varients</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{$varients}}</div>
                            </div>
                            <div class="col-auto">
